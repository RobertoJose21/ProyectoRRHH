...
Public Class FrmEmpleadoSueldoTotal
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            Cnn.Open()
            Comando.CommandText = "select * from V_EmpleadoSueldoTotal"
            ...
            If Lector.HasRows = True Then
                While Lector.Read
                    ...
                    Fila.SubItems.Add(CStr(Lector.Item(5)))
                    Fila.SubItems.Add(CStr(Lector.Item(6)))
