...
Public Class FrmDistritoXEmpleado
    Private Sub ComboBox1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            ...
            oConeccion.Open()
            oComando.CommandText = "ProdEmpleado_Distrito"
            oComando.CommandType = CommandType.StoredProcedure
            oComando.Parameters.Add("@NombreDistrito", SqlDbType.VarChar, 40).Value = ComboBox1.Text
    ...
    Private Sub FrmDistritoXEmpleado_Load(sender As Object, e As EventArgs) Handles MyBase.Load
