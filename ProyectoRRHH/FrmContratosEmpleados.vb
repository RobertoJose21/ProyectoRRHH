...
Public Class FrmContratosEmpleados
    Private Sub FrmContratosEmpleados_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Try
            ...
            oConeccion.Open()
            oComando.CommandText = "ProdEmpleado_Contrato"
            oComando.CommandType = CommandType.StoredProcedure
            oComando.Parameters.Add("@empleado", SqlDbType.VarChar, 40).Value = ComboBox1.Text
